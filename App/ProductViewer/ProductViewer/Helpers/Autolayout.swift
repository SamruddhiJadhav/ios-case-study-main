...
extension UIBarButtonItem {
    static func backButton(_ target: Any?, action: Selector) -> UIBarButtonItem {
        let button = UIBarButtonItem(image: .init(systemName: "chevron.backward"), style: .plain, target: target, action: action)
        return button
    }
}
